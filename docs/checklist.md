...
> Generated by product v0.1 | Last updated: 2026-06-20
...
### FT-136 — Read-model state space and UI-step state coverage [x]

- [x] ADR-080: Read models declare a state space; UI steps cover it constrained and complete (accepted)
- [x] TC-1000: UI step covers every projection state (scenario) — passing
