...
> Generated by product v0.1 | Last updated: 2026-06-25
...
### FT-139 — Design system and reification rules [x]

- [x] ADR-083: Screens bind to a design system; AIOs reify to CIOs by context of use (accepted)
- [x] TC-1009: AIO reifies to different CIOs by context (scenario) — passing
