...
> Generated by product v0.1 | Last updated: 2026-06-02
...
- [ ] TC-768: default-target-fallback-uses-human-template (scenario) — unimplemented
- [ ] TC-769: mcp-product-context-uses-id-parameter (scenario) — unimplemented
...
### FT-107 — Split product-cli into product-core, product-mcp, product-cli workspace [~]
