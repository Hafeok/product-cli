...
fn render_resolution(report: &ReachReport, s: &mut String) {
    ...
    s.push_str(&format!(
        ...
        r.not_read_to_resolved, r.not_read_to_boundary, r.resolved + r.not_read_to_resolved, r.scored + r.not_read_to_resolved, r.coverage_cg96_percent
    ));
