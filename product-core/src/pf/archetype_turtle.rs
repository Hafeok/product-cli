//! Turtle projection of an assembled archetype — its How plus layout rules.
//!
...
pub fn archetype_to_turtle(how: &HowContract, layout: Option<&LayoutModel>) -> String {
...
mod tests {
    ...
    fn projects_layout_rules_with_enforces_edges() {
        ...
        let ttl = archetype_to_turtle(&how, Some(&layout));
    ...
    fn no_layout_is_just_the_how() {
        let how = HowContract::from_yaml(HOW).expect("how");
        assert_eq!(archetype_to_turtle(&how, None), how_to_turtle(&how));
    }
}
