...
pub(crate) const DEFAULT_PROMPTS: &[(&str, &str, &str)] = &[
    ...
    ("author-domain", "author-domain-v1.md", "1"),
    ("author-how", "author-how-v1.md", "1"),
...
pub(crate) fn default_content(name: &str) -> String {
    match name {
        ...
        "author-domain" => include_str!("domain_prompt.md").replace("{{PRODUCT}}", "<product>"),
        "author-how" => include_str!("prompts/author_how.txt").to_string(),
