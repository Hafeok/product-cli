...
> Generated by product v0.1.4 | 2026-05-27T14:00:53.376188111+00:00
...
- Phase 5: LOCKED (37/41 complete)
- 50 ADRs
- 715 test criteria (679 passing, 0 failing, 32 unimplemented)
- 21 dependencies
...
observes: [String]   # Default: []. Observed surface(s) per ADR-051.
                     # Allowed: file, graph, exit-code, tag, stdout,
                     # stderr, disk-state, mcp-response (extensible via
                     # [tc-observability].custom). Required for
                     # scenario/session/smoke/contract TCs at
                     # phase >= [tc-observability].required-from-phase.
