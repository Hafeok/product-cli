...
> Generated by product v0.1.2 | 2026-05-11T10:10:37.825617420+00:00
...
- 65 features across 5 phases
- Phase 1 — Core CLI & Graph: OPEN (22/22 complete)
- Phase 2: OPEN (4/4 complete)
- Phase 3: OPEN (6/6 complete)
- Phase 4: OPEN (1/1 complete)
- Phase 5: OPEN (32/32 complete)
- 48 ADRs
- 633 test criteria (627 passing, 0 failing, 2 unimplemented)
- 21 dependencies
...
api, consensus, data-model, error-handling, iam, networking, observability, scheduling, security, storage, testing
